...
<?php function showdata1 ()
	 ...
	 $query = "SELECT  `Bookingno` FROM `users` WHERE `id`='$session' " ;
	...
	$Bookingno = $data['Bookingno'];
	 ...
	 $query = "SELECT `phone`,`longitude`, `latitude` FROM `users` WHERE `id`='$Bookingno' AND `Mode`='Driver'" ;
	...
	?>
	   <script> var latdrv = <?php echo $data['latitude'];?> ;
                  var londrv = <?php echo $data['longitude'];?> ;
...
var myCenterdrvr = {lat:latdrv, lng: londrv};
function myMap() {
